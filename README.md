...
Frames are extracted and processed in real-time

YOLO detects vehicles and crash patterns

Sudden changes (collision, deformation, unusual motion) are identified

System flags the event as a car crash
...
Works on both live and recorded video
...
Provides visual output with labeled frames
...
Deployment on web/mobile interface
